        ...
        {selectionMode && (
          ...
          >
            ...
            <button
              type="button"
              onClick={() =>
                navigate("/tickets/new", { state: routerState })
              }
              style={{
              ...
              <div style={{ ...DROPDOWN, minWidth: 288, padding: 18 }}>
                {coords ? (
                  ...
                  <div>
                    ...
                    >
                      Showing all providers regardless of distance. Enable GPS
                      in your browser for distance-based filtering and sorting.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div style={{ position: "relative", flex: "1 1 0", minWidth: 0 }}>
            ...
            {openSeg === "budget" && (
              ...
              >
                ...
                <div style={{ ...FILTER_HEAD, marginBottom: 10 }}>
                  Custom range
                </div>
        ...
        >
          ...
          <section ref={resultsRef}>
              ...
              <span style={{ fontSize: 14, color: "var(--text-muted)" }}>
                {isLoading ? (
                  ...
                  <>
                    ...
                    provider{totalElements !== 1 ? "s" : ""} found
                  </>
                ) : null}
              </span>
              <span style={{ flex: 1 }} />
            ...
            {!isLoading && sortedResults?.length === 0 && (
              ...
              >
                No providers match your current filters. Try broadening the
                radius, removing a trade filter, or clearing the experience
                requirement.
              </div>
            )}
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        alignItems: "flex-start",
                        transition:
                          "border-color 0.12s, transform 0.12s, box-shadow 0.12s",
                        cursor: "pointer",
                      }}
                      onMouseEnter={(e) => {
                        const el = e.currentTarget;
                        el.style.borderColor = "var(--border-strong, #94a3b8)";
