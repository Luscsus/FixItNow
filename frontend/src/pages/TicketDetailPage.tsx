  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="grow" />
        <span className="mono" style={{ fontSize: 10.5, color: "var(--text-muted)", background: "var(--slate-100)", padding: "3px 8px", borderRadius: 6, letterSpacing: "0.05em", textTransform: "uppercase" }}>
          Coming soon
        </span>
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 18, display: "flex", flexDirection: "column", gap: 14 }}>
        {!providerName && (
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", color: "var(--text-muted)", gap: 8, padding: "24px 16px" }}>
            <div style={{ width: 48, height: 48, borderRadius: 24, background: "var(--slate-100)", display: "grid", placeItems: "center", fontSize: 22, marginBottom: 4 }}>
              💬
            </div>
        ...
        {providerName && (
          <>
            <div className="mono muted" style={{ textAlign: "center", fontSize: 10.5, margin: "4px 0" }}>
              Chat history · placeholder
            </div>
            {PLACEHOLDER_MESSAGES.map((msg, i) => (
              <div key={i} style={{ maxWidth: "86%", display: "flex", flexDirection: "column", gap: 4, alignSelf: msg.mine ? "flex-end" : "flex-start", alignItems: msg.mine ? "flex-end" : "flex-start" }}>
                <div style={{ padding: "10px 14px", borderRadius: 12, borderBottomRightRadius: msg.mine ? 4 : 12, borderBottomLeftRadius: msg.mine ? 12 : 4, background: msg.mine ? "var(--navy-700)" : "var(--slate-100)", color: msg.mine ? "#fff" : "var(--text)", fontSize: 14, lineHeight: 1.45 }}>
                  {msg.text}
                </div>
      ...
      <div style={{ borderTop: "1px solid var(--border)", padding: "12px 14px", display: "flex", gap: 8, alignItems: "center", opacity: providerName ? 0.5 : 0.35, pointerEvents: "none" }}>
        <div style={{ flex: 1, background: "var(--slate-100)", borderRadius: 10, padding: "10px 14px", fontSize: 14, color: "var(--text-muted)" }}>
          Messaging coming soon…
        </div>
        <button className="btn btn-primary btn-sm" disabled style={{ opacity: 0.5 }}>Send</button>
      </div>
    </div>
  );
}
