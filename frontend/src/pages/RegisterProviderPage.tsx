...
export function RegisterProviderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const categories = TRADES.filter((t) => selectedTrades.includes(t.id)).map(
      (t) => t.category,
    );
    ...
    <div className="auth">
      ...
      <div className="auth-art">
        ...
        <Link to="/" className="auth-brand-inv">
          ...
          <span>
            FixIt<span className="brand-now">Now</span>
          </span>
        </Link>
        ...
        >
          <div>
            ...
            <h1
              className="display"
              style={{ color: "#fff", fontSize: "clamp(40px,4.5vw,64px)" }}
            >
              Your skills.
              <br />
              Your rates.
          ...
          <div className="col" style={{ gap: 0 }}>
            ...
            <div className="feature-row">
              ...
              <span className="fbody">
                <b>Set your own rate.</b> You decide what you charge per hour.
            ...
            <div className="feature-row">
              ...
              <span className="fbody">
                <b>Jobs come to you.</b> Get matched to nearby requests in your
                trade automatically.
              </span>
            </div>
            <div className="feature-divider" />
            <div className="feature-row">
              ...
              <span className="fbody">
                <b>Guaranteed payment.</b> Escrow means you always get paid for
                approved work.
              </span>
            </div>
            <div className="feature-divider" />
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="body muted">
                Your application is pending administrator approval. You'll be
                notified by email once it's reviewed.
              </p>
              <Link
                to="/login"
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="col" style={{ gap: 24 }}>
                  ...
                  <div className="col" style={{ gap: 16 }}>
                    ...
                    >
                      <div className="field grow">
                        <label className="field-label" htmlFor="prov-first">
                          First name
                        </label>
                        <div
                      ...
                      <div className="field grow">
                        <label className="field-label" htmlFor="prov-last">
                          Last name
                        </label>
                        <div
                    ...
                    <div className="field">
                      <label className="field-label" htmlFor="prov-email">
                        Email address
                      </label>
                      <div
                    ...
                    <div className="field">
                      <label className="field-label" htmlFor="prov-phone">
                        Phone number
                      </label>
                      <div
                        className={`input-wrap${errors.phoneNumber ? " error" : ""}`}
                      >
                        <IconPhone />
                        <input
                          id="prov-phone"
                      ...
                      <span className="field-hint">
                        Customers will use this to reach you about jobs.
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  >
                    <div className="field grow">
                      <label className="field-label" htmlFor="prov-lat">
                        Latitude
                      </label>
                      <div
                        className={`input-wrap${errors.location ? " error" : ""}`}
                      >
                        <input
                          id="prov-lat"
                          className="input"
                    ...
                    <div className="field grow">
                      <label className="field-label" htmlFor="prov-lon">
                        Longitude
                      </label>
                      <div
                        className={`input-wrap${errors.location ? " error" : ""}`}
                  ...
                  >
                    Latitude must be between −90 and 90, longitude between −180
                    and 180.
                  </span>
                </div>
                  ...
                  <div className="trade-grid">
                    {TRADES.map((trade) => (
                      <button
                        ...
                        aria-pressed={
                          selectedTrades.includes(trade.id) ? "true" : "false"
                        }
                ...
                <div>
                  ...
                  >
                    <div className="field grow">
                      <label className="field-label" htmlFor="prov-years">
                        Years of experience
                      </label>
                      <div
                        className={`input-wrap${errors.yearsOfExperience ? " error" : ""}`}
                      >
                        <input
                          id="prov-years"
                          className="input"
                    ...
                    <div className="field grow">
                      <label className="field-label" htmlFor="prov-radius">
                        Service radius
                      </label>
                      <select
                        id="prov-radius"
                ...
                <div>
                  ...
                  <div className="field">
                    <label className="field-label" htmlFor="prov-bio">
                      Short bio (optional)
                    </label>
                    <textarea
                      id="prov-bio"
                    ...
                    >
                      {errors.bio ? (
                        ...
                        <span className="field-hint">
                          Visible on your provider profile.
                        </span>
                      )}
                      <span className="field-hint">
                        {bio.length} / {BIO_MAX}
