  ...
  return (
    <div className="rail-card">
      ...
      <div style={{ background: "var(--navy-50)", border: "1px solid var(--navy-100)", borderRadius: 10, padding: 14, marginBottom: 14 }}>
        <div className="mono" style={{ fontSize: 10.5, color: "var(--navy-700)", letterSpacing: "0.08em", textTransform: "uppercase", fontWeight: 600 }}>{t("providerAccount.payouts_nextDeposit")}</div>
      ...
      <button className="btn btn-secondary btn-sm btn-full" style={{ marginTop: 14 }}>{t("providerAccount.payouts_viewAll")}</button>
    </div>
  );
}
